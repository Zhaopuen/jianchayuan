...
Page({
  ...
  bindTextAreaBlur: function (e) {
    ...
    console.log(that.data.concent,'bbbbbbbbb')
  },
  // 线索管理员回复线索
  xiansuoreply: function(){
    var that = this;
    var userInfo = wx.getStorageSync('user_info').data;
    Trequest({
      url:'clue_report/reply',
      data:{
        user_id:userInfo.id,
        id: that.data.applyId,
        replycontent: that.data.concent
      },
      callback(res){
        console.log(res,'这是回复的返回信息')
