        ...
        return l(e, {
            start: function(e, t, r) {
                ...
                0 !== t.length && (l.attr = t.reduce(function(e, t) {
                    ...
                    return "class" == r && (l.classStr = s), "style" == r && (l.styleStr = s + ";height:auto"), 
                    s.match(/ /) && (s = s.split(" ")), e[r] ? Array.isArray(e[r]) ? e[r].push(s) : e[r] = [ e[r], s ] : e[r] = s, 
                    e;
                }, {})), "img" === l.tag) {
                    l.imgIndex = o.images.length, l.attr = l.attr || {};
                    var m = l.attr.src || null;
                    m && "" == m[0] && m.splice(0, 1), m = i.urlTohttpsUrl(m, s), l.attr.src = m, l.from = a, 
