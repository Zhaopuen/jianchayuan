module.exports = function Trequest(a) {
  ...
  // }
  wx.request({
    url: 'https://procuratorate.fengsh.cn/api/' + a.url,
    header: a.header || {
    ...
    complete: function (t) {
      ...
      }), console.log("--- request https error >>>"), console.log(t.statusCode), console.log(t.data),
        console.log("<<< request https error ---")), a.complete && a.complete(t);
    }
  });
};